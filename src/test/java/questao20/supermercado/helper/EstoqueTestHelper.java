...
public class EstoqueTestHelper {
    ...
    public static final Integer QTD_PARA_DAR_BAIXA_MENOR_QUE_A_QTD_ESTOQUE_PRODUTO_1 = 7;
    public static final Integer QTD_PARA_DAR_BAIXA_MAIOR_QUE_A_QTD_ESTOQUE_PRODUTO_1 = 17;
